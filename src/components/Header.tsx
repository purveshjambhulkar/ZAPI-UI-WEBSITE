...
export function Header() {
  ...
  return (
    <header className="sticky top-0 z-50 w-full border-b border-border/40 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60">
      <div className="container flex h-16 items-center">
        ...
        <div className="flex flex-1 items-center justify-end space-x-4">
          <nav className="flex items-center space-x-2">
            ...
            <ModeToggle />
            <Button asChild size="sm" className="hidden md:flex rounded-full px-4">
      ...
      {showMobileMenu && (
        <div className="border-b border-border bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 md:hidden">
          <div className="container flex flex-col space-y-3 py-4">
            ...
            <Button asChild size="sm" className="mt-2 w-full rounded-full">
              <Link to="/docs" onClick={() => setShowMobileMenu(false)}>Get Started</Link>
            </Button>
          </div>
        </div>
      )}
